  ...
  return (
    <Link href={href}>
      <div
        className={`${
          styles.roundedCard
        } rounded-card shadow-2xl overflow-hidden cursor-pointer inline-flex items-center justify-center relative w-40 h-40 lg:w-48 lg:h-48 rounded-full border border-4 border-white mx-auto ${
          className ? className : ""
        }`}
      >
        <div
